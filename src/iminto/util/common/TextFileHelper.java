...
public class TextFileHelper {
    ...
    public static void write(File file, String content)
            throws IOException {
        write(file, content, Constant.CHARSET);
    }
    ...
    public static void write(File file, InputStream is)
            throws IOException {
        write(file, newReader(is, Constant.CHARSET), Constant.CHARSET);
    }
    ...
    public static void write(File file, Reader reader, String charset)
        ...
        try {
            ...
            char[] buffer = new char[Constant.BUFFER_CHAR_SIZE];
            int read = 0;
    ...
    public static String read(File file)
            throws IOException {
        return read(file, Constant.CHARSET);
    }
    ...
    public static String read(InputStream is)
            throws IOException {
        return read(is, Constant.CHARSET);
    }
    ...
    public static void append(File file, String content)
            throws IOException {
        append(file, content, Constant.CHARSET);
    }
