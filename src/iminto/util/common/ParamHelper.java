...
public class ParamHelper {
     ...
     * @return
     */
    public static final int genParam(int i) {
        i = i < 0 ? 0 : i;
        i = i > 30 ? 30 : i;
        return (1 << 31) - 1 ^ (1 << i);
    }
     ...
     * @return
     */
    public static final boolean contain(int args, int arg) {
     ...
     * @return
     */
    public static final int genParamPlus(int i) {
        i = i < 0 ? 0 : i;
        i = i > 30 ? 30 : i;
        return 1 << i;
    }
     ...
     * @return
     */
    public static final boolean containPlus(int args, int arg) {
        return (args & arg) != 0;
    }
     ...
     * @return
     */
    public static final int genParamOr(int i) {
     ...
     * @return
     */
    public static final boolean containOr(int args, int arg) {
