...
public class Base64 {
	...
	public static byte[] encodeToByte(String s) {
		try {
			return encodeToByte(s.getBytes(Constant.CHARSET), false);
	...
	public static byte[] encodeToByte(String s, boolean lineSep) {
		try {
			return encodeToByte(s.getBytes(Constant.CHARSET), lineSep);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String decodeToString(byte[] arr) {
		try {
			return new String(decode(arr), Constant.CHARSET);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String encodeToString(String s) {
		try {
			return new String(encodeToChar(s.getBytes(Constant.CHARSET), false));
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String encodeToString(String s, boolean lineSep) {
		try {
			return new String(encodeToChar(s.getBytes(Constant.CHARSET), lineSep));
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
	...
	public static String decodeToString(String s) {
		try {
			return new String(decode(s), Constant.CHARSET);
		} catch (UnsupportedEncodingException ignore) {
			return null;
		}
	}
